        ...
        >
          <div  className="row gap-3 ">
            ...
            >
              ...
              <p className="benifits-para">
                Self-learning through its structured study techniques and
                analysis tool.
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="benifits-para">
                Co-ordinated use of learning and skilling towards successful
                career building.
              </p>
            </div>
          </div>
          ...
          <div className="row gap-3 mt-3">
            ...
            >
              ...
              <p className="benifits-para">
                Well defined academic passage with assessments evaluations and
                validations
              </p>
            </div>
            <div
            ...
            >
              ...
              <p className="benifits-para">
                Utilizes the content to get optimum results in the learnersHelps
                in progressive and thorough learning with assessments, enhances
